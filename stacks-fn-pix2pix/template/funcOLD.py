...
def infer(img):
    ...
    gen_model = load_model(home_dir + "generator_model.h5", compile=False)
    ...
    result.save("generated_img.jpg", "JPEG")
    outputString = outputString + 'Saved image to generated_img.png\n'
...
def handler(ctx, data: io.BytesIO=None):
    outputString = outputString + "\033[92m" + "[INFO] " + "\033[0m" + " : initializing inference..\n")
